    ...
    <div className="flex h-screen sm:items-center sm:justify-center">
      <div className="bg-white overflow-hidden shadow sm:rounded-lg w-full max-w-xl">
        <div className="p-4 sm:p-10">
          <h3 className="text-xl leading-6 font-medium text-gray-900">Welcome to GoodHub!</h3>
          <p className="mt-2 text-sm text-gray-800">
            It's great to have you. We just need you to confirm a few details for us and then you can start making
            change.
          </p>
          <div>{user ? <OnboardingForm user={user} setPerson={setPerson}></OnboardingForm> : null}</div>
        </div>
      </div>
    </div>
  );
