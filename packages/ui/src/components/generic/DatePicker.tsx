...
export const DatePicker: FC<DatePickerProps> = ({ calendar, viewing, selected, viewPreviousMonth, viewNextMonth, isSelected, inRange, onDayClick }) => {
  return <Card className="py-2 z-20">
