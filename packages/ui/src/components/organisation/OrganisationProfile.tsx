  ...
  return (
    <>
      ...
      <Page
        ...
        title={<Title size="3xl">{organisation ? organisation?.name : <Skeleton width="300" />}</Title>}
        // actions={[
        ...
        {organisation?.hero ? (
          <div className="flex flex-col mt-4">
            {organisation.hero.image ? (
              <div className="bg-white shadow-sm h-32 w-full lg:h-48 rounded-md overflow-hidden relative">
                <BackgroundImage image={organisation.hero.image} />
              </div>
            ) : null}
            <div className="max-w-5xl mx-auto w-full px-4 sm:px-6 lg:px-8 z-10">
              <div className="-mt-20 sm:-mt-24 sm:flex sm:items-end sm:space-x-5">
                <div className="flex">
                  {/* @ts-ignore */}
                  <img
                    className="h-24 w-24 bg-white rounded-lg shadow-md ring-4 ring-white sm:h-32 sm:w-32"
                    src={organisation?.profilePicture?.original}
                    alt={organisation?.profilePicture?.alt}
                  />
                </div>
              </div>
              ...
              <div>{organisation?.externalLinks ? <ExternalLinks links={organisation?.externalLinks} /> : null}</div>
