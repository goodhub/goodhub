...
const CreateUpdatePostWizard: FC<CreateUpdatePostWizardProps> = ({
  modalState,
  onDismiss,
  organisation,
  existingPost,
          ...
          >
            <Step id="Who and what" validate={["organisationId", "projectId"]}>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                ...
                <FeaturedContentOption
                  selected={config.featuredContent === FeaturedContentType.Link}
                  option={FeaturedContentType.Link}
                  onClick={() =>
                    setConfig({
                      ...config,
                ...
                <FeaturedContentOption
                  selected={config.featuredContent === FeaturedContentType.Text}
                  option={FeaturedContentType.Text}
                  onClick={() =>
                    setConfig({
                      ...config,
            ...
            <Step id="Where to send">
              <div className="flex flex-col">
                ...
                {organisation?.social?.[ISocial.Facebook] ? (
                  <Connection
                    name="Facebook"
