import { Content, IHeroImage, IPost, IPostIdentity, IPostOrigin, IPostType } from '../../../../shared';
...
const getIconForOption = (option: FeaturedContentType) => {
  switch (option) {
    ...
    case FeaturedContentType.Graphic:
      return (
        <svg className="h-6 sm:h-10" viewBox="0 0 57 36" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M55.6245 0.771729H0.874531C0.469608 0.771729 0.144531 1.09966 0.144531 1.50173V34.3517C0.144531 34.7538 0.469608 35.0817 0.874531 35.0817H55.6245C56.0295 35.0817 56.3545 34.7538 56.3545 34.3517V1.50173C56.3545 1.09966 56.0295 0.771729 55.6245 0.771729ZM54.8945 33.6217H1.60453V2.23173H54.8945V33.6217Z"
            fill="#454545"
          />
          <path
            d="M8.17443 22.3066C10.5897 22.3066 12.5544 20.3419 12.5544 17.9266C12.5544 15.5114 10.5897 13.5466 8.17443 13.5466C5.75916 13.5466 3.79443 15.5114 3.79443 17.9266C3.79443 20.3419 5.75916 22.3066 8.17443 22.3066ZM8.17443 15.0066C9.78554 15.0066 11.0944 16.3155 11.0944 17.9266C11.0944 19.5377 9.78554 20.8466 8.17443 20.8466C6.56332 20.8466 5.25443 19.5377 5.25443 17.9266C5.25443 16.3155 6.56332 15.0066 8.17443 15.0066Z"
            fill="#454545"
          />
          <path
            d="M4.52443 11.3568H11.8244C12.2294 11.3568 12.5544 11.0289 12.5544 10.6268V6.97683C12.5544 6.57476 12.2294 6.24683 11.8244 6.24683H4.52443C4.11951 6.24683 3.79443 6.57476 3.79443 6.97683V10.6268C3.79443 11.0289 4.11951 11.3568 4.52443 11.3568ZM5.25443 7.70683H11.0944V9.89682H5.25443V7.70683Z"
            fill="#454545"
          />
          <path
            d="M4.52443 29.6068H11.8244C12.2294 29.6068 12.5544 29.2789 12.5544 28.8768V25.2268C12.5544 24.8248 12.2294 24.4968 11.8244 24.4968H4.52443C4.11951 24.4968 3.79443 24.8248 3.79443 25.2268V28.8768C3.79443 29.2789 4.11951 29.6068 4.52443 29.6068ZM5.25443 25.9568H11.0944V28.1468H5.25443V25.9568Z"
            fill="#454545"
          />
          <path
            d="M15.4746 31.4316H51.9746C52.3796 31.4316 52.7046 31.1037 52.7046 30.7016V5.15163C52.7046 4.74956 52.3796 4.42163 51.9746 4.42163H15.4746C15.0697 4.42163 14.7446 4.74956 14.7446 5.15163V30.7016C14.7446 31.1037 15.0697 31.4316 15.4746 31.4316ZM16.2046 5.88163H51.2446V29.9716H16.2046V5.88163Z"
            fill="#454545"
          />
          <path
            d="M42.6268 6.44092C42.3417 6.15576 41.8798 6.15576 41.5945 6.44092L39.0168 9.02161L24.8219 23.2194C24.7649 23.2736 24.7193 23.3391 24.685 23.4076L22.1043 28.5689C21.9646 28.8484 22.0188 29.1905 22.2412 29.4129C22.381 29.5527 22.5692 29.6268 22.7574 29.6268C22.8686 29.6268 22.9798 29.6011 23.0824 29.5498L28.2438 26.9691C28.3122 26.9349 28.3778 26.8893 28.432 26.8322L45.2073 10.0568C45.3442 9.91996 45.4212 9.7346 45.4212 9.5407C45.4212 9.3468 45.3442 9.16144 45.2073 9.02457L42.6268 6.44092ZM27.4852 25.7144L24.3884 27.2628L25.9368 24.166L39.533 10.5697L41.0814 12.1181L27.4852 25.7144ZM42.1136 11.0888L40.5652 9.54042L42.1136 7.99202L43.662 9.54042L42.1136 11.0888Z"
            fill="#454545"
          />
        </svg>
      );
    ...
    case FeaturedContentType.Link:
      return (
        <svg className="h-6 sm:h-10" viewBox="0 0 62 38" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M59.9868 0.323486H1.29455C0.703989 0.323486 0.227079 0.802256 0.227079 1.39095L0.228942 36.4624C0.228942 37.0511 0.705852 37.5299 1.29641 37.5299H59.9872C60.5759 37.5299 61.0546 37.0511 61.0546 36.4624L61.0528 1.39095C61.0528 0.802256 60.5755 0.323486 59.9868 0.323486ZM58.9174 2.45842V9.61779H2.36178V2.45842H58.9174ZM2.36178 35.3948V11.7524H58.9174V35.3948H2.36178Z"
            fill="#454545"
          />
          <path
            d="M54.0069 7.68592H55.1694C55.7581 7.68592 56.2369 7.20715 56.2369 6.61846V5.45785C56.2369 4.86915 55.7581 4.39038 55.1694 4.39038H54.0069C53.4182 4.39038 52.9395 4.86915 52.9395 5.45785V6.61846C52.9395 7.20901 53.4164 7.68592 54.0069 7.68592V7.68592Z"
            fill="#454545"
          />
          <path
            d="M48.4383 7.68592H49.6008C50.1895 7.68592 50.6683 7.20715 50.6683 6.61846V5.45785C50.6683 4.86915 50.1895 4.39038 49.6008 4.39038H48.4383C47.8496 4.39038 47.3708 4.86915 47.3708 5.45785V6.61846C47.3708 7.20901 47.8496 7.68592 48.4383 7.68592V7.68592Z"
            fill="#454545"
          />
          <path
            d="M42.8702 7.68592H44.0327C44.6214 7.68592 45.1001 7.20715 45.1001 6.61846V5.45785C45.1001 4.86915 44.6214 4.39038 44.0327 4.39038H42.8702C42.2815 4.39038 41.8027 4.86915 41.8027 5.45785V6.61846C41.8027 7.20901 42.2796 7.68592 42.8702 7.68592V7.68592Z"
            fill="#454545"
          />
        </svg>
      );
...
const FeaturedContentOption: FC<FeaturedContentOptionProps> = ({ option, onClick }) => {
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex flex-col justify-center items-center h-24 pt-3 pb-1.5 rounded-md shadow-sm border border-gray-300 cursor-pointer"
    >
...
export const NewPostModal: FC<NewPostModalProps> = ({ orgId, state, onDismiss }) => {
  const { register, handleSubmit, setValue, errors } = useForm<NewPostFormFields>({
    defaultValues: { type: IPostType.Update, postedIdentity: IPostIdentity.Organisation }
  });
  ...
  return (
    <Modal className="max-w-5xl w-full" state={state} onDismiss={onDismiss}>
      <form className="flex flex-col sm:flex-row max-h-screen" onSubmit={handleSubmit(submit)}>
          ...
          {!featuredContent ? (
            <div className="grid gap-4 grid-cols-5 mt-2">
              <FeaturedContentOption
                ...
                onClick={() => setFeaturedContent({ type: FeaturedContentType.Picture })}
              ></FeaturedContentOption>
        ...
        <div className="mt-4 sm:mt-0 sm:ml-4 sm:pl-4 w-full sm:w-72 sm:border-l border-gray-300 justify-between flex flex-col">
          <div>
            <TextField
              name="type"
              validationMessage="Post type is required."
              validationFailed={errors.type}
              register={register}
              placeholder="What kind of post is this?"
            ></TextField>
            <TextField
              name="postedIdentity"
              validationMessage="Identity is required."
              validationFailed={errors.postedIdentity}
              register={register}
              placeholder="Who do you want to post this as?"
            ></TextField>
          </div>
          <div className="mt-4 flex justify-between">
            <Button onClick={onDismiss} className="mr-4">
              Discard
            </Button>
