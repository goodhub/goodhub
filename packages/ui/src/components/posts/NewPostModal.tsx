...
const getIconForOption = (option: FeaturedContentType) => {
  switch (option) {
    case FeaturedContentType.Picture:
      return <svg className="h-6 sm:h-10" viewBox="0 0 59 38" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    case FeaturedContentType.Video:
      return <svg className="h-6 sm:h-10" viewBox="0 0 57 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    case FeaturedContentType.Graphic:
      return <svg className="h-6 sm:h-10" viewBox="0 0 57 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    case FeaturedContentType.Link: 
      return <svg className="h-6 sm:h-10" viewBox="0 0 62 38" fill="none" xmlns="http://www.w3.org/2000/svg">
