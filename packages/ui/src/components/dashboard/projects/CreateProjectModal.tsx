...
export const CreateProjectModal: FC<CreateProjectModalProps> = ({ state, orgId, onDismiss }) => {
  ...
  return (
    <Modal className="max-w-xl w-full" state={state} onDismiss={onDismiss}>
      <form className="flex flex-col w-full" onSubmit={handleSubmit(submit)}>
        ...
        <TextField
          ...
          validationMessage="A name is required to make a service"
          placeholder="The name of your new service"
        ></TextField>
        <TextField
          register={register}
          name="description"
          validationFailed={errors.description}
          validationMessage="A description is required to make a service"
          placeholder="A brief description of your new service"
        ></TextField>
