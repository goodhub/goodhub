...
const OrganisationBasicsConfiguration: FC<OrganisationBasicsConfigurationProps> = () => {
  ...
  return <>
    <TextField 
      name="name" placeholder="Local Park Trust"
      register={register}
    ...
    />
    <TextField 
      name="description" placeholder="A community to improve and maintain our beautiful local park"
      register={register}
    ...
    <Title size="lg" className="mt-6 mb-2">Contact information</Title>
    <TextField 
    ...
    />
    <TextField 
      name="UKCharityNumber" placeholder="123456"
      register={register}
