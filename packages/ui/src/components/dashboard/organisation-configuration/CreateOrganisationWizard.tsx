  ...
  return (
    <Modal padding="p-0" layout="items-center" state={modalState} onDismiss={onDismiss}>
      <FormProvider {...methods}>
        <form>
          <Wizard name={Navigation.actions.registerOrganisation} onComplete={methods.handleSubmit(submit)}>
            ...
            <Step id="Choosing your categories" validate={['tags']}>
              ...
              <p className="block text-sm font-medium text-gray-700">
                Which of these categories fits {name}'s primary aims? Choose those that align with your mission: “
                {description}”.
              </p>
            ...
            <Step id="Invite other team members">
              {!isRedirecting ? (
                <>
                  ...
                  <p className="block text-sm font-medium text-gray-700">
                    You can invite other people to join you at {name} if you want. Don't worry, you can skip this and do
                    it later.
                  </p>
                  <MultiTextField
                    name="teamMembers"
                ...
                <div className="flex h-full flex-col items-center justify-center">
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="my-5 max-w-xl">
                      <p>
                        Give us a moment to set up your new organisation, you will be redirected to your new dashboard
                        shortly. Remember, your organisation won't be verified right away and you might be contacted by
                        one of our team.
                      </p>
                    </div>
                  </div>
