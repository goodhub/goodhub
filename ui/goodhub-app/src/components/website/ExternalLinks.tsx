...
const Link: FC<{link: IExternalLink}> = ({ link }) => {
  return <a className="flex-1 p-4 flex flex-col items-center sm:items-start sm:p-8 border-gray-100 border-b last:border-b-0 sm:border-b-0 sm:border-r sm:last:border-r-0" href={link.url} target="_blank" rel="noreferrer">
    <div className="flex flex-row sm:flex-col mb-2 sm:mb-0 items-center sm:items-start">
      <FiGlobe className="w-10 h-10 rounded-md text-primary-appropriate bg-primary p-2" />
